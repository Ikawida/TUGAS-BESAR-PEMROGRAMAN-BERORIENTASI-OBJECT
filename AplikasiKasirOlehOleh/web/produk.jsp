        ...
        <table>
            ...
            %>
                <tr>
                    ...
                    <td><%= p.getSisaStok() %></td>
                    <td class="actions">
                        <a href="produk?action=edit&kode=<%= p.getKodeProduk() %>" class="btn">Edit</a>
                        <a href="produk?action=delete&kode=<%= p.getKodeProduk() %>" class="btn" onclick="return confirm('Hapus produk ini?')">Hapus</a>
                    </td>
                </tr>
            <% } %>
            </tbody>
