...
| **Modularization**  | Memisahkan kode ke dalam modul/folder berdasarkan tanggung jawab.                            | - Folder `model` untuk entitas, `dao` untuk data access, `controller` untuk servlet, `util` untuk tools umum.                                                                                             | Struktur folder proyek                                                        | Kode lebih terstruktur, mudah dipahami dan dikelola oleh tim.                               |
---
# Struktur Database
---
